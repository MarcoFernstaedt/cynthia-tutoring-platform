...
export const metadata: Metadata = pageMetadata({
  title: 'Reading Tutoring in Tucson, AZ & Online',
  description: 'Personalized virtual reading tutoring for K-12 students, homeschool learners, college students, and adult learners. Based in Tucson, Arizona and available online.',
...
export default function Page() {
  return (
    <ServiceLandingPage
      ...
      bullets={['K-12 reading support','Adult reading development','Homeschool language arts','Online sessions from Tucson, Arizona']}
